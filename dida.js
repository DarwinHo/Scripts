...
const didaGetCookieRegex = /^https?:\/\/www\.didapinche\.com\/hapis\/api\/rs\/active\/.*\?cid=.*/;
...
let didaCid = 'b8e2d6c9-de09-43c4-8df2-16727713326c';
let didaCookie = `access_token=cH32SgczZM0S7vusO8bYCcagnwtScu5fWVtjiZMrUeQYSsdYk9kPgV2GJwc70PDO12DRpin5LkyLmAVGvJDfFb3CE/YccYVgWPWgcCoEbtPB1eiFEtrwjSKuOW+JcbLH; smidV2=20210106164410d956883271a4116e94ed44eb8885b36200ee1a370a025a170; acw_tc=2f6a1fda16099268158955506eb3b568b04e2713b085982e9676d356119f4a`;
let didaUserAgent = 'DidaPinche/8.10.36 dc(eyJsYXQiOjIyLjc5MjU2MCwibG9uIjoxMTMuOTU4NTUwfQ==) (iOS 14.3;iPhone11,8) [[App]] Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148';
let didaCinfo = ``;
let didaAccessToken = `cH32SgczZM0S7vusO8bYCcagnwtScu5fWVtjiZMrUeQYSsdYk9kPgV2GJwc70PDO12DRpin5LkyLmAVGvJDfFb3CE/YccYVgWPWgcCoEbtPB1eiFEtrwjSKuOW+JcbLH`;
